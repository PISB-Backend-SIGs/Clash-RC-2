    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('q_stat', models.CharField(choices=[('TLE', 'Time Limit Exceeded'), ('MLE', 'Memory Limit Exceeded'), ('CE', 'Compilation Error'), ('RE', 'Runtime Error'), ('AC', 'Accepted')], max_length=5, null=True)),
